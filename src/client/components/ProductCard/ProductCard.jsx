  ...
  return (
    <>
      ...
      <Dialog
        ...
        sx={{
          backgroundImage:
            "linear-gradient(to left, rgba(238,130,238,0.3), rgba(75,0,130,0.3), rgba(0,0,255,0.3), rgba(0,128,0,0.3), rgba(255,255,0,0.3), rgba(255,0,0,0.3))",
          bgcolor: "none",
        }}
      >
        ...
        <DialogContent>
          <CardMedia
            ...
            image={image}
            alt={title}
            sx={{ maxWidth: "650px", maxHeight: "75vh" }}
          />
        </DialogContent>
      </Dialog>
    </>
